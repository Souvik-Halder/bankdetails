...
function Cards() {
    ...
    const options = [
        ...
        },
        {
            id: 4,
            name: "Sun",
            content: "This is the sun Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, Nonea! Maiores et perferendis eaque, exercitationem praesentium nihil."
        },
        {
            id: 5,
            name: "Moon",
            content: "This is the moon Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, Nonea! Maiores et perferendis eaque, exercitationem praesentium nihil."
        },
        {
        id: 6,
            name: "Volcano",
            content: "This is the volcano Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, Nonea! Maiores et perferendis eaque, exercitationem praesentium nihil."
        }
    ]
  return (
    <div>
...

{
    options.map((option) => {
        return (
            <div key={option.id} class="rounded overflow-hidden shadow-lg my-3">
